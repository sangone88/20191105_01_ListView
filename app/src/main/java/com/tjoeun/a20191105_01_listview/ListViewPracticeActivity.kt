...
import com.tjoeun.a20191105_01_listview.adapters.PostAdapter
...
class ListViewPracticeActivity : AppCompatActivity() {
    ...
    fun addPosts() {
        ...
        postList.add(PostData("11번째 글입니다.", "내용을 11번째로 적습니다."))
        postList.add(PostData("12번째 글입니다.", "내용을 12번째로 적습니다."))
        postList.add(PostData("13번째 글입니다.", "내용을 13번째로 적습니다."))
        postList.add(PostData("14번째 글입니다.", "내용을 14번째로 적습니다."))
        postList.add(PostData("15번째 글입니다.", "내용을 15번째로 적습니다."))
